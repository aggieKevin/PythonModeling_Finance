...
class Stock(object):
    def __init__(self,buyList,sellList,currentPrice):
        ...
        self.initilize(currentPrice)

    def initilize(self,currentPrice): #set positionBuy, positionSell, currentShare
    ...
    def getProfit(self,currentPrice):
        return self.currentShares*currentPrice+self.totalMoneySell-self.totalMoneyBuy
